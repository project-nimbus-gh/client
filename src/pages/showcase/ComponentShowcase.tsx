...
function generateRealisticTemperature(dayIndex: number, totalDays: number): number {
  ...
  const seasonalTemp =
    warmTemp + ((coolTemp - warmTemp) * (1 - Math.cos((yearProgress * 2 * Math.PI) / 2))) / 2;
...
export function ComponentShowcase() {
  ...
  return (
    <div className="app">
          ...
          <Card elevated>
            ...
            <CardBody>
              <div className="form-grid">
                <Input label="Standard Input" placeholder="Enter text..." fullWidth />
                <Input
      ...
      >
        <p>
          This is an example modal component. It can contain any content you want, and you can
          customize the buttons and callbacks.
        </p>
        <br></br>
        <Input label="Enter something" placeholder="Type here..." fullWidth />
      </Modal>
      ...
      >
        <p>
          This is an alert dialog. It's typically used for important information or notifications
      ...
      >
        <p>
          Are you sure you want to proceed with this action? This is a confirmation dialog that
